...
const Card = React.forwardRef<
  HTMLDivElement,
  React.HTMLAttributes<HTMLDivElement> & { glass?: boolean; gradient?: boolean }
  ...
  <div
    ...
    className={cn(
      ...
      glass
        ...
        : "bg-card border-white/5 shadow-card-dark",
      gradient && "bg-gradient-to-br from-blue-500/5 to-violet-500/5",
      className
    )}
    {...props}
  />
